        ...
        <h2 className="text-md mb-2 px-4 pt-4">
          <div className="flex justify-between">
            <div className="badge relative top-0">
              <span className="mt-2 py-1 h-12px text-md font-semibold w-12px rounded right-1 bottom-1 px-4">{resolvedAddress}</span>
            </div>
          </div>
        </h2>
          ...
          <div className="flex justify-between items-center">
            <div className="space-y-2">
              <span className="flex space-x-2 items-center">
                ...
                {weatherData && <span>{weatherData.windspeed}km/h</span>}
              </span>
              <span className="flex space-x-2 items-center">
                <svg height="20" width="20" viewBox="0 0 32 32" className="fill-current">
                ...
                {weatherData && <span>{weatherData.humidity}%</span>}
              </span>
            </div>
            
            <div>
            {weatherData && <h1 className="text-6xl">{weatherData.temp}°C</h1>}
            </div>
          </div>
        </div>
      </div>
