                    ...
                    <div className="relative rounded-lg shadow w-full max-w-2xl">
                        ...
                        <div className="flex items-center p-4 md:p-5  rounded-b dark:border-gray-600">
                            <button
                                onClick={cerrarModal}
                                type="button"
                                className="mx-auto text-white bg-zinc-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            >
