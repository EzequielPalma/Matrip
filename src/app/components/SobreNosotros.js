...
export default function SobreNosotros() {
  return (
    <div className="bg-gray-800 bg-opacity-75 p-8 rounded-md shadow-lg mb-20">
      ...
      <p className="text-white text-lg text-left">En el mágico universo de MATRIP, te sumergirás en una experiencia única donde cada rincón de la ciudad cobra vida con un toque de magia. Somos más que una simple guía; somos tu pase de entrada a un viaje lleno de descubrimientos, sabores y secretos que te transportarán a un Madrid mágico y encantador.</p>
      <p className="text-white text-lg mt-4 text-left">Descubre los tesoros ocultos que van más allá de la realidad cotidiana. Explora calles empedradas que cuentan historias olvidadas, descubre puertas secretas que te llevan a dimensiones insospechadas y despierta la curiosidad que hay en ti mientras te sumerges en los encantos ocultos de la ciudad.</p>
