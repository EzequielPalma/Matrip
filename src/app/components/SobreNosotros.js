      ...
      <div className="bg-gray-800 bg-opacity-75 p-8 rounded-md shadow-lg h-auto	w-auto		 md:w-3/4 lg:w-1/2 xl:w-1/3 mx-auto flex items-center justify-center  mb-4">
        <div className="text-center">
          ...
          <div className="flex flex-col items-center mt-4">
            <button className="text-slate-100	 bg-zinc-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-4">
